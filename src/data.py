...
FD004 has 6 operating conditions and 2 failure modes — the hardest of the
four C-MAPSS subsets. Both train and test are run-to-failure trajectories
recorded per engine:
...
def load_rul_fd004() -> pd.Series:
    ...
    Returns a Series of length 248, index 0..247 aligning with test units 1..248.
    """
